...
| ST BayesRC scheduled-chains BED | scalar | mixture | annotation probit stick | component | scalar | SNP-major packed BED | Phase 14B guarded lexical per-chain implementation; exact full sweep, ordered probit sticks and chain-local RNG | Production behavior and Phase 14A references unchanged; typed callable boundary not active; migration in progress and noncanonical | Alignment/dispatch/aggregation/conversion remain adapter-owned; adaptive controls do not apply |

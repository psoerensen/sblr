...
| ST BayesC fixed marker prior | scalar | binary | fixed_marker/global | fixed_marker | scalar | CSR | Production unchanged; typed contracts and exact references established | Not migrated; seam documented; recommended Phase 9B target | Immutable marker policy isolated |

...
::: {.callout-note}
This page preserves general derivations and conceptual empirical-Bayes
constructions. Functions whose names end in `_conceptually` are mathematical
pseudocode, not package APIs. Executable package fits use the seven canonical
fitters described in the [model overview](../notes/model_overview.qmd).
:::

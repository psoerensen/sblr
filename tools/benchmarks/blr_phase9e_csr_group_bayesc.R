# Canonical group CSR BayesC timing and completed-fit RSS baseline.
# Run manually from the package root; this script is not part of ordinary tests.
...
cat("environment:", R.version.string, "; sblr", as.character(utils::packageVersion("sblr")),
    ...
    "; compiler", R.version$compiler, ";", R.version$platform, "\n")

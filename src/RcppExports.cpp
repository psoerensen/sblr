...
RcppExport SEXP _sblr_stblr_cpg_omp_csr_block_eigen(SEXP wySEXP, SEXP wwSEXP, SEXP yySEXP, SEXP b_initSEXP, SEXP d_initSEXP, SEXP use_d_initSEXP, SEXP r_initSEXP, SEXP use_r_initSEXP, SEXP rebuild_r_before_updateESEXP, SEXP ld_prefixSEXP, SEXP BSEXP, SEXP ESEXP, SEXP ssb_priorSEXP, SEXP sse_priorSEXP, SEXP piSEXP, SEXP nubSEXP, SEXP nueSEXP, SEXP updateBSEXP, SEXP updateESEXP, SEXP updatePiSEXP, SEXP adjESEXP, SEXP nSEXP, SEXP nitSEXP, SEXP nburnSEXP, SEXP nthinSEXP, SEXP pi_prior_aSEXP, SEXP pi_prior_bSEXP, SEXP ncoresSEXP, SEXP seedSEXP, SEXP nchainsSEXP, SEXP keep_chainsSEXP, SEXP chain_seedsSEXP, SEXP updateLDswapSEXP, SEXP ld_swap_probSEXP, SEXP ld_swap_r2SEXP, SEXP ld_swap_max_friendsSEXP, SEXP ld_swap_movesSEXP, SEXP selection_s_prior_scaleSEXP, SEXP estimate_selection_sSEXP, SEXP selection_s_initSEXP, SEXP selection_s_priorSEXP, SEXP selection_s_proposal_sdSEXP, SEXP selection_s_log_hSEXP, SEXP convergence_markersSEXP, SEXP convergence_bSEXP, SEXP convergence_dSEXP, SEXP bed_filesSEXP, SEXP n_bedSEXP, SEXP clsSEXP, SEXP rowsSEXP, SEXP afSEXP, SEXP block_startSEXP, SEXP eigen_filterSEXP, SEXP eigen_tauSEXP, SEXP eigen_etaSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::vector<std::vector<double>> >::type wy(wySEXP);
    ...
    Rcpp::traits::input_parameter< double >::type eigen_tau(eigen_tauSEXP);
    Rcpp::traits::input_parameter< double >::type eigen_eta(eigen_etaSEXP);
    rcpp_result_gen = Rcpp::wrap(stblr_cpg_omp_csr_block_eigen(wy, ww, yy, b_init, d_init, use_d_init, r_init, use_r_init, rebuild_r_before_updateE, ld_prefix, B, E, ssb_prior, sse_prior, pi, nub, nue, updateB, updateE, updatePi, adjE, n, nit, nburn, nthin, pi_prior_a, pi_prior_b, ncores, seed, nchains, keep_chains, chain_seeds, updateLDswap, ld_swap_prob, ld_swap_r2, ld_swap_max_friends, ld_swap_moves, selection_s_prior_scale, estimate_selection_s, selection_s_init, selection_s_prior, selection_s_proposal_sd, selection_s_log_h, convergence_markers, convergence_b, convergence_d, bed_files, n_bed, cls, rows, af, block_start, eigen_filter, eigen_tau, eigen_eta));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type eigen_tau(eigen_tauSEXP);
    Rcpp::traits::input_parameter< double >::type eigen_eta(eigen_etaSEXP);
    rcpp_result_gen = Rcpp::wrap(stblr_cpg_omp_csr_bayesr_block_eigen(wy, ww, yy, b_init, comp_init, use_comp_init, r_init, use_r_init, rebuild_r_before_updateE, ld_prefix, B, E, ssb_prior, sse_prior, pi, mixture_var, alpha, nub, nue, updateB, updateE, updatePi, adjE, n, nit, nburn, nthin, ncores, seed, nchains, keep_chains, chain_seeds, updateE_start, updateE_every, updateLDswap, ld_swap_prob, ld_swap_r2, ld_swap_max_friends, ld_swap_moves, selection_s_prior_scale, estimate_selection_s, selection_s_init, selection_s_prior, selection_s_proposal_sd, selection_s_log_h, convergence_markers, convergence_probability, convergence_b, convergence_d, convergence_component, bed_files, n_bed, cls, rows, af, block_start, eigen_filter, eigen_tau, eigen_eta));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type eigen_tau(eigen_tauSEXP);
    Rcpp::traits::input_parameter< double >::type eigen_eta(eigen_etaSEXP);
    rcpp_result_gen = Rcpp::wrap(stblr_cpg_omp_csr_sbayesrc_block_eigen(wy, ww, yy, b_init, comp_init, use_comp_init, r_init, use_r_init, rebuild_r_before_updateE, ld_prefix, B, E, ssb_prior, sse_prior, A, gamma, alpha_init, sigmaSqAlpha_init, intercept_flat, sigmaSqAlpha_a, sigmaSqAlpha_b, pi_floor, nub, nue, updateAlpha, updateB, updateE, alpha_update_every, adjE, n, nit, nburn, nthin, ncores, seed, nchains, keep_chains, chain_seeds, updateLDswap, ld_swap_prob, ld_swap_r2, ld_swap_max_friends, ld_swap_moves, selection_s_prior_scale, estimate_selection_s, selection_s_init, selection_s_prior, selection_s_proposal_sd, selection_s_log_h, convergence_markers, convergence_annotations, convergence_b, convergence_d, convergence_component, bed_files, n_bed, cls, rows, af, block_start, eigen_filter, eigen_tau, eigen_eta));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sblr_stblr_cpg_omp_csr_block_eigen", (DL_FUNC) &_sblr_stblr_cpg_omp_csr_block_eigen, 55},
    ...
    {"_sblr_stblr_cpg_omp_csr_bayesr_block_eigen", (DL_FUNC) &_sblr_stblr_cpg_omp_csr_bayesr_block_eigen, 59},
    ...
    {"_sblr_stblr_cpg_omp_csr_sbayesrc_block_eigen", (DL_FUNC) &_sblr_stblr_cpg_omp_csr_sbayesrc_block_eigen, 63},

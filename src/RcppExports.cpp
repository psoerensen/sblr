...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(stblr_cpg_omp_csr(wy, ww, yy, b_init, d_init, use_d_init, r_init, use_r_init, rebuild_r_before_updateE, ld_prefix, B, E, ssb_prior, sse_prior, pi, nub, nue, updateB, updateE, updatePi, adjE, n, nit, nburn, nthin, pi_prior_a, pi_prior_b, ncores, seed, nchains, keep_chains, chain_seeds, updateLDswap, ld_swap_prob, ld_swap_r2, ld_swap_max_friends, ld_swap_moves));
    return rcpp_result_gen;
END_RCPP
}
// stblr_cpg_omp_csr_annot
std::vector<std::vector<std::vector<double>>> stblr_cpg_omp_csr_annot(std::vector<std::vector<double>> wy, std::vector<std::vector<double>> ww, std::vector<double> yy, std::vector<std::vector<double>> b_init, std::vector<std::vector<double>> d_init, bool use_d_init, std::vector<std::vector<double>> r_init, bool use_r_init, bool rebuild_r_before_updateE, std::string ld_prefix, arma::mat B, arma::mat E, std::vector<std::vector<double>> ssb_prior, std::vector<std::vector<double>> sse_prior, std::vector<double> pi, arma::mat A, bool learn_pi_annot, bool learn_vb_annot, arma::mat eta_pi_init, arma::mat eta_vb_init, double sigma_eta_pi, double sigma_eta_vb, double rw_sd_eta_pi, double rw_sd_eta_vb, int annot_update_every, double pi_min, double pi_max, double vb_multiplier_min, double vb_multiplier_max, double nub, double nue, bool updateB, bool updateE, bool updatePi, double adjE, std::vector<int> n, int nit, int nburn, int nthin, double pi_prior_a, double pi_prior_b, int ncores, int seed);
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_sblr_stblr_cpg_omp_csr_bayesr", (DL_FUNC) &_sblr_stblr_cpg_omp_csr_bayesr, 35},

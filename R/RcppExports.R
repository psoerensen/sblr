...
stblr_block_low_rank_contract_internal <- function(bed_files, n_bed, cls, rows, af, block_start, wy, effects, eigen_prop = 0.995) {
    .Call(`_sblr_stblr_block_low_rank_contract_internal`, bed_files, n_bed, cls, rows, af, block_start, wy, effects, eigen_prop)
}

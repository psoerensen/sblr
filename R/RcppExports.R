...
stblr_cpg_omp_csr <- function(wy, ww, yy, b_init, d_init, use_d_init, r_init, use_r_init, rebuild_r_before_updateE, ld_prefix, B, E, ssb_prior, sse_prior, pi, nub, nue, updateB, updateE, updatePi, adjE, n, nit, nburn, nthin, pi_prior_a, pi_prior_b, ncores, seed, nchains, keep_chains, chain_seeds, updateLDswap = FALSE, ld_swap_prob = 0.05, ld_swap_r2 = 0.8, ld_swap_max_friends = 50L, ld_swap_moves = 1L, selection_s_prior_scale = NULL, estimate_selection_s = FALSE, selection_s_init = 0.0, selection_s_prior = as.numeric( c(-2.0, 2.0)), selection_s_proposal_sd = 0.05, selection_s_log_h = NULL) {

...
#' [stblr_block_eigen()], [stblr_bed()], and [mtblr_bed()]. Corrected
#' independent-summary multi-trait Cheng BayesC-Pi analyses use the public CSR
#' and block-eigen interfaces.
#'
